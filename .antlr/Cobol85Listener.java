// Generated from c:/Users/david.balseca/OneDrive - NEXTI BUSINESS SOLUTIONS SAS/Escritorio/New NexTI/CursorProjects/ANTLR/cobol2plsql-antlr-full/Cobol85.g4 by ANTLR 4.13.1
...
public interface Cobol85Listener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by the {@code execSqlIncludeOrDeclare}
	 * labeled alternative in {@link Cobol85Parser#dataDescriptionEntryExecSql}.
	 * @param ctx the parse tree
	 */
	void enterExecSqlIncludeOrDeclare(Cobol85Parser.ExecSqlIncludeOrDeclareContext ctx);
	/**
	 * Exit a parse tree produced by the {@code execSqlIncludeOrDeclare}
	 * labeled alternative in {@link Cobol85Parser#dataDescriptionEntryExecSql}.
	 * @param ctx the parse tree
	 */
	void exitExecSqlIncludeOrDeclare(Cobol85Parser.ExecSqlIncludeOrDeclareContext ctx);
	/**
	 * Enter a parse tree produced by the {@code execSqlLine}
	 * labeled alternative in {@link Cobol85Parser#dataDescriptionEntryExecSql}.
	 * @param ctx the parse tree
	 */
	void enterExecSqlLine(Cobol85Parser.ExecSqlLineContext ctx);
	/**
	 * Exit a parse tree produced by the {@code execSqlLine}
	 * labeled alternative in {@link Cobol85Parser#dataDescriptionEntryExecSql}.
	 * @param ctx the parse tree
	 */
	void exitExecSqlLine(Cobol85Parser.ExecSqlLineContext ctx);
	/**
	 * Enter a parse tree produced by {@link Cobol85Parser#dataCopyStatement}.
	 * @param ctx the parse tree
	 */
	void enterDataCopyStatement(Cobol85Parser.DataCopyStatementContext ctx);
	/**
	 * Exit a parse tree produced by {@link Cobol85Parser#dataCopyStatement}.
	 * @param ctx the parse tree
	 */
	void exitDataCopyStatement(Cobol85Parser.DataCopyStatementContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by the {@code execSqlOther}
	 * labeled alternative in {@link Cobol85Parser#execSqlStatement}.
	 * @param ctx the parse tree
	 */
	void enterExecSqlOther(Cobol85Parser.ExecSqlOtherContext ctx);
	/**
	 * Exit a parse tree produced by the {@code execSqlOther}
	 * labeled alternative in {@link Cobol85Parser#execSqlStatement}.
	 * @param ctx the parse tree
	 */
	void exitExecSqlOther(Cobol85Parser.ExecSqlOtherContext ctx);
	/**
	 * Enter a parse tree produced by the {@code execSqlLineOther}
	 * labeled alternative in {@link Cobol85Parser#execSqlStatement}.
	 * @param ctx the parse tree
	 */
	void enterExecSqlLineOther(Cobol85Parser.ExecSqlLineOtherContext ctx);
	/**
	 * Exit a parse tree produced by the {@code execSqlLineOther}
	 * labeled alternative in {@link Cobol85Parser#execSqlStatement}.
	 * @param ctx the parse tree
	 */
	void exitExecSqlLineOther(Cobol85Parser.ExecSqlLineOtherContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link Cobol85Parser#stringSendingList}.
	 * @param ctx the parse tree
	 */
	void enterStringSendingList(Cobol85Parser.StringSendingListContext ctx);
	/**
	 * Exit a parse tree produced by {@link Cobol85Parser#stringSendingList}.
	 * @param ctx the parse tree
	 */
	void exitStringSendingList(Cobol85Parser.StringSendingListContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link Cobol85Parser#subscriptOrReference}.
	 * @param ctx the parse tree
	 */
	void enterSubscriptOrReference(Cobol85Parser.SubscriptOrReferenceContext ctx);
	/**
	 * Exit a parse tree produced by {@link Cobol85Parser#subscriptOrReference}.
	 * @param ctx the parse tree
	 */
	void exitSubscriptOrReference(Cobol85Parser.SubscriptOrReferenceContext ctx);
	/**
	 * Enter a parse tree produced by {@link Cobol85Parser#expression}.
	 * @param ctx the parse tree
	 */
	void enterExpression(Cobol85Parser.ExpressionContext ctx);
	/**
	 * Exit a parse tree produced by {@link Cobol85Parser#expression}.
	 * @param ctx the parse tree
	 */
	void exitExpression(Cobol85Parser.ExpressionContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link Cobol85Parser#specialMacroStatement}.
	 * @param ctx the parse tree
	 */
	void enterSpecialMacroStatement(Cobol85Parser.SpecialMacroStatementContext ctx);
	/**
	 * Exit a parse tree produced by {@link Cobol85Parser#specialMacroStatement}.
	 * @param ctx the parse tree
	 */
	void exitSpecialMacroStatement(Cobol85Parser.SpecialMacroStatementContext ctx);
}